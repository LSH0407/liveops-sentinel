...
class MetricBus(QObject):
    ...
    def start(self):
        ...
        try:
            ...
            print(f"백엔드 프로세스 시작됨: PID {self.backend_process.pid}")
    ...
    def _process_metrics(self, data: dict):
        ...
        if obs_data:
            self._store_metric('obs.dropped_ratio', ts, obs_data.get('dropped_ratio', 0))
            self._store_metric('obs.encoding_lag_ms', ts, obs_data.get('encoding_lag_ms', 0))
            self._store_metric('obs.render_lag_ms', ts, obs_data.get('render_lag_ms', 0))
    ...
    def update_obs_metrics(self, obs_metrics: Dict):
        ...
        if self.latest_snapshot:
            ...
            self._store_metric('obs.encoding_lag_ms', ts, obs_metrics.get('encoding_lag_ms', 0))
