@echo off
echo ========================================
echo Fix Autoreconf Errors and Create Release
echo ========================================
echo.
...
echo.
echo [3/7] Committing autoreconf fixes...
git commit -m "Fix autoreconf errors: reorder system dependencies, add build tools"
if %errorlevel% neq 0 (
...
echo.
echo ========================================
echo AUTORECONF FIXES COMPLETED!
echo ========================================
echo.
echo Changes made:
echo - Moved system dependencies installation before vcpkg setup
echo - Added build-essential, cmake, git to system dependencies
