@echo off
echo ========================================
echo Fix CMakeLists.txt and Create Release
echo ========================================
echo.
...
echo.
echo [2/7] Committing CMake fix...
git commit -m "Fix CMakeLists.txt compatibility issues - remove RUNTIME_DEPENDENCY_SET"
if %errorlevel% neq 0 (
...
echo.
echo ========================================
echo CMAKE FIX COMPLETED!
echo ========================================
echo.
echo Changes made:
echo - Removed RUNTIME_DEPENDENCY_SET (CMake 3.21+ feature)
echo - Simplified install rules for better compatibility
echo - Fixed CMakeLists.txt syntax errors
echo - Cleaned up GitHub Actions workflow
echo.
echo GitHub Actions will now:
echo - Successfully configure CMake without errors
