@echo off
echo ========================================
echo Fix Autoreconf Errors - Complete Solution
echo ========================================
echo.
...
echo.
echo [3/7] Committing complete autoreconf fixes...
git commit -m "Fix autoreconf errors: add debug flag, enhance system dependencies"
if %errorlevel% neq 0 (
...
echo.
echo ========================================
echo AUTORECONF COMPLETE FIXES COMPLETED!
echo ========================================
echo.
echo Changes made:
echo - Added --debug flag to vcpkg install for better error reporting
echo - Enhanced system dependencies with additional libraries
echo - Fixed autoreconf errors in Linux build
echo.
echo GitHub Actions will now:
echo - Install complete system dependencies
echo - Use --debug flag for vcpkg dependencies
